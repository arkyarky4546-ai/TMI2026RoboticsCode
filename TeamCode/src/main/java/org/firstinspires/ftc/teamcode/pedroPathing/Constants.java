...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
           ...
           .forwardZeroPowerAcceleration(-45.3382333333) //-45.5667 -38.02 -43.17 -44.278 (old was -42.06)
            .lateralZeroPowerAcceleration(-80.901) //-86.7 -77.14 -85.96 -90.84 -78.865 (very inconsistent - old was -82)
            .translationalPIDFCoefficients(new PIDFCoefficients(0.12, 0, 0.01, 0.045)) //looked good to me
            .headingPIDFCoefficients(new PIDFCoefficients(1.2, 0, 0.035, 0.03)) //bumped p up from 1.1 to 1.12
            .drivePIDFCoefficients(new FilteredPIDFCoefficients(0.03,0.0,0.00002,0.6,0.01)) //seemed fine
