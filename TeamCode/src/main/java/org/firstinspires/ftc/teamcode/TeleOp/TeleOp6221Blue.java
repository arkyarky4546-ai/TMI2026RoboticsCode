...
@Configurable
//@TeleOp
public class TeleOp6221Blue extends OpMode {
    ...
    public void loop() {
       ...
       /* if (gamepad2.yWasPressed()){
        ...
        if (gamepad2.dpadDownWasPressed()){
            double pos = turretLeft.getPosition() - 0.01;
            turretLeft.setPosition(pos);
            turretRight.setPosition(pos);
        }
        if(gamepad2.dpadUpWasPressed()){
            //turret.setTargetCoordinates(follower.getPose().getX(), follower.getPose().getY());
            double pos = turretLeft.getPosition() + 0.01;
            turretLeft.setPosition(pos);
            turretRight.setPosition(pos);
        }
