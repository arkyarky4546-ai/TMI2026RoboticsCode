...
import org.firstinspires.ftc.teamcode.colorv2;

import java.util.List;

    @Autonomous(name = "testv2", group = "Autonomous")
    public class testv2 extends OpMode {
        ...
        public void init() {
            ...
            hehe = new colorv2(hardwareMap, smart1, shooter, shooter2, coloora, intake, intake1, wally, push);
