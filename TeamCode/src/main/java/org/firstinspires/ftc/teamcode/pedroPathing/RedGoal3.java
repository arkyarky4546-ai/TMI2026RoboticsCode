...
@Autonomous(name = "RedGoal3", group = "Autonomous")
public class RedGoal3 extends OpMode {
    ...
    private final Pose scorePose = new Pose(90, -92, Math.toRadians(-49));//this is where we should intake the BALLS idk where it is at this time so change late
    private final Pose endPose = new Pose(120, -120, Math.toRadians(-45));
