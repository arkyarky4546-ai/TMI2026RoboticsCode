...
public class ShooterConstants {
    ...
    public static Pose GOAL_POSE_RED1 = new Pose(-40,-88);
    public static Pose GOAL_POSE_BLUE1 = new Pose(-40,-67);
    public static double Score_Height = 32; //measured from the flywheel not the turret, but it should work for either
    public static double Score_Angle = Math.toRadians(-25);
   // public static double Score_Angle = Math.toRadians(-30);
    ...
    public static double getFlyWheelTicksFromVelocity(double velocity){
        ...
        return MathFunctions.clamp(5.81395348837*(velocity-49.1) + 230, flyMin, flyMax); //changed to 250 from 200
    }
}