...
public class ShooterConstants {
    ...
    public static double Hood_Max_Angle = 1;
    public static double Hood_Min_Angle = .53;//from like 0 to pi
    public static double hoodDegreesToServoTicks(double radians){ //turn calculated velocity to motor commands
        ...
        return Range.clip(-1.18*radians + 1.17, Hood_Min_Angle, Hood_Max_Angle); //our brains are
    }
    public static double getFlyWheelTicksFromVelocity(double velocity){
        ...
        return Range.clip(5.81395348837*(velocity-49.1) + 200, flyMin, flyMax);
    }
}
